...
const EmptyContent = ({ ...other }) => {
  ...
  return (
    <Box {...other}>
      <svg viewBox="0 0 327 240" xmlns="http://www.w3.org/2000/svg" width="100%" height="100%">
        <defs>
          <linearGradient id={id('b')} x1="19.496%" x2="77.479%" y1="70.898%" y2="18.101%">
        ...
        <g fill="none" fillRule="evenodd">
          ...
          <g transform="translate(78 50)">
            <use fill="#dfe3e8" stroke="#919eab" strokeOpacity={0.48} strokeWidth={1.5} xlinkHref={`#${id('a')}`} />
            <g fillRule="nonzero">
              <path
